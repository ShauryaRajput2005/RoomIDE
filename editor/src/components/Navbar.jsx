      ...
      <div className="w-full bg-[#121417] px-4 sm:px-6 py-2 flex items-center justify-between shadow-lg overflow-x-auto">
        <div className="flex  flex-row items-end gap-2 sm:gap-3 shrink-0 w-1/2  " >
          <img
            src={logo}
            alt="Logo"
            className="h-[40px] sm:h-[50px] object-contain flex self-start hover:scale-102"
          />
          <span className="text-[10px] sm:text-md md:text-sm text-[#49de6f] font-medium sm:flex hover:scale-102">
